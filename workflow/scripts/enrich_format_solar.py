...
def main(asset_path, ts_path, vre_selection, vre_path):
    ...
    print(">>> formatting solar dataset initiated....")
    
    # These all derived from configuration file
    asset_path = cfg['output']['create_ext_solar_assets']['fname']
    ts_path = cfg['output']['create_ext_solar_ts']['fname']
    vre_selection = cfg['output']['enrich_format_solar']['vre_sel']
    vre_path = "data/pypsa_data/" + cfg['output']['pypsa_dict']['solar']
    ...
    print(">>> formatting solar dataset completed !")
    
if __name__ == '__main__':
    # 
    main("data/pypsa_data/bc_solar_assets.csv", "results/interim/bc_solar_ts.csv", "solar", "/home/pmcwhannel/repos/PyPSA_BC/results/pypsa-components/bc_solar.pickle")
