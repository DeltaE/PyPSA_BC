...
'''
    ...
    python substation_load.py <ARG1> <ARG2> <ARG3> <ARG4>

    ARG1 = The GADM file
    ARG2 = Folder containing both hourly residential and hourly CSMI loads (regional)
    ARG3 = Year of data to disaggregate to substations
    ARG4 = The substations.csv file
    ARG5 = 'geo' or 'pop', geocenter or population center
    ARG6 = The municipality file (the one that was created manually)
    ARG7 = The output folder to write substation_hourly_X_<YEAR>.csv to

    EXAMPLE:

    python substation_load.py gadm41_CAN_2.json .\hourly_load_region 2020 .\data-pull\network\substations.csv pop municipality.csv .\hourly_load_substation
